...
$schimb_telefon_password = $_POST['schimb_telefon_password'];
	 ...
	 $sql = 'BEGIN schimbare_tel(:id, :schimb_telefon_password, :schimb_telefon); END;';
	 $stmt = oci_parse($conn, $sql);
...
function SergeFurnizor()
{
	global $conn;
	$id = $_POST['id_sterge_furnizor'];
	$sql = "begin DELETE_FURNIZOR(:id); end;";
	$stmt = oci_parse($conn,$sql);
	oci_bind_by_name($stmt,':id',$id,32);
	oci_execute($stmt);
}

function StergeServiciu()
{
	global $conn;
	$nume = $_POST['nume_sterge_serviciu'];
	$sql = "begin delete_serviciu(:nume); end;";
	$stmt = oci_parse($conn,$sql);
...
<h3> Cont </h3>
<h3>Informatii:<br>
 <form action="p33.php" method="post">
...
<h2>Schimba parola </h2>
 ...
 <input type="password" name="oldpassword" placeholder="Vechea parola"><br><br>
  ...
  <input type="submit" name="pass_chng_submit" value="Schimba">
</form> 
...
<h2>Schimba numarul de telefon </h2>
 <form action="p33.php" method="post">
  ...
  <input type="submit" name="schimbatelefon" value="Schimba">
</form>
...
<h2>Adauga furnizor </h2>
 <form action="p33.php" method="post">
  ...
  <input type="submit" name="adaugafurnizor" value="Adauga">
</form>

<h2>Sterge un furnizor </h2>
 <form action="p33.php" method="post">
      <input type="user" name="id_sterge_furnizor" placeholder="Id furnizor"><br><br>
  <input type="submit" name="sterge_furnizor" value="Sterge">
</form>

<h2>Adauga serviciu </h2>
 <form action="p33.php" method="post">
  <input type="user" name="nume_serviciu" placeholder="Nume serviciu"><br><br>
  <input type="submit" name="adaugaserviciu" value="Adauga">
</form>

<h2>Sterge serviciu </h2>
 <form action="p33.php" method="post">
  <input type="user" name="nume_sterge_serviciu" placeholder="Nume serviciu"><br><br>
  <input type="submit" name="sterge_serviciu" value="Sterge">
</form>
...
if(isset($_POST['sterge_furnizor']))
{
	SergeFurnizor();
}

if(isset($_POST['sterge_serviciu']))
{
	StergeServiciu();
}
?>